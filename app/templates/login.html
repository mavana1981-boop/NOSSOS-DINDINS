...
<div class="login-page">
  <div class="login-art login-art-photo" style="background-image: linear-gradient(135deg, rgba(26,22,18,0.55) 0%, rgba(26,22,18,0.25) 45%, rgba(26,22,18,0.85) 100%), url('{{ url_for('static', filename='img/hero.jpg') }}');">
    <div>
    ...
    <div class="text-faint text-small">© {{ current_year }} · nosso espaço</div>
  </div>
